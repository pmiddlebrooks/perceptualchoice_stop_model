...
setenv('pathStr', '/Volumes/HD-1/Users/paulmiddlebrooks/perceptualchoice_stop_model/data/2015-11-28-1842/preproc01/subj%.2d/dt%d/%s/%s/SAM_%sTrials_model%.3d.mat');
