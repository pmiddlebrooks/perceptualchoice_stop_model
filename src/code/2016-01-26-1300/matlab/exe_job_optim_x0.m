...
setenv('pathStr', '/Volumes/HD-1/Users/paulmiddlebrooks/perceptualchoice_stop_model/data/2016-01-08-1245/preproc01/subj%.2d/dt%d/%s/%s/SAM_%sTrials.mat');
setenv('pathStrInitParam','/Volumes/HD-1/Users/paulmiddlebrooks/perceptualchoice_stop_model/data/2016-01-08-1245/preproc01/subj%.2d/dt%d/%s/%s/SAM_initParam_%sTrials_model%.3d.mat');
