...
fileStr.root   = fullfile(modelRoot,'data/2016-03-10-1000/preproc01/subj%.2d/dt%d/%s/%s/');
fileStr.root   = fullfile(modelRoot,'data/2015-12-23-1100/preproc01/subj%.2d/dt%d/%s/%s/');
...
%% Troubleshooting parameter recovery
...
cd(fullfile(modelRoot,'src/code/2016-01-08-1245/matlab'));

[simData,obs,prd] = job_simulate_data(subject,model,architecture,dt,trialVar,simScope,fileStr,nSim,plotFlag);
%%
