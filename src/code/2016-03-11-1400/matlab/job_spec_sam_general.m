...
for iSubj = subj
    ...
    % v_{Go}, ve_{Go}, allowed to vary between stimuli;
    % zc_{Go}, z0_{Go}, and t0_{G0} allowed to vary between responses;
    % zc_{Go}, v_{Go}, ve_{Go}, wli_{Go}, and wffi_{Go} are allowed to vary between conditions
    features(2,XCat.i.iZ0,1)      = true; %pgm
    features(2,XCat.i.iZc,1)      = true;
    features(3,XCat.i.iZc,1)      = true;
    features(1,XCat.i.iV,1)       = true;
    features(1,XCat.i.iVe,1)      = true;
