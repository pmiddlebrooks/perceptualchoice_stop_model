...
switch subject
    case 'broca'
% Easy Left
allData.cnd(trialData.targ1CheckerProp == 0.43)  = 1;
% Intermediate Left
allData.cnd(trialData.targ1CheckerProp == 0.45)  = 2;
% Hard Left
allData.cnd(trialData.targ1CheckerProp == 0.47)  = 3;
% Hard Right
allData.cnd(trialData.targ1CheckerProp == 0.53)  = 4;
% Intermediate Right
allData.cnd(trialData.targ1CheckerProp == 0.55)  = 5;
% Easy Right
allData.cnd(trialData.targ1CheckerProp == 0.57)  = 6;
    case 'xena'
% Easy Left
allData.cnd(trialData.targ1CheckerProp == 0.35)  = 1;
% Intermediate Left
allData.cnd(trialData.targ1CheckerProp == 0.42)  = 2;
% Hard Left
allData.cnd(trialData.targ1CheckerProp == 0.47)  = 3;
% Hard Right
allData.cnd(trialData.targ1CheckerProp == 0.53)  = 4;
% Intermediate Right
allData.cnd(trialData.targ1CheckerProp == 0.58)  = 5;
% Easy Right
allData.cnd(trialData.targ1CheckerProp == 0.65)  = 6;
    otherwise
        error('Need to enter color coherence values for this subject, job_preproc_data line 193')
end
% Primary stimulus (go-signal) index
% =========================================================================
allData.rsp1(trialData.targ1CheckerProp < 0.5) = 1;
allData.rsp1(trialData.targ1CheckerProp > 0.5) = 2;
