...
fileStr.root   = fullfile(modelRoot,'data/2016-03-25-1300/preproc01/subj%.2d/dt%d/%s/%s/');
...
iModel = model;
    ...
    ds0325 = sortrows(ds,'FunctionValue')
...
choiceMech              = 'race';
stopMech                = 'none';
fileStr.root            = strcat(modelRoot,'/data/2016-03-25-1300/preproc01/subj%.2d/dt10/%s/%s/');
doPlot                  = true;
doSave                  = true;
doStartParCluster       = false;

cd(fullfile(modelRoot,'src/code/2016-03-25-1300/matlab'));
