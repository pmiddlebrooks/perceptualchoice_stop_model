...
% =========================================================================
nSSDMin         = 70; % minimum # of stop trials for a SSD to be included
truncateSSD     = true;
...
% =========================================================================
saccRemove = (allData.stm2 == 0 & allData.rt < 100) | allData.rt > 2000;


allData(errorTrial | abortTrial | saccRemove,:) = [];
