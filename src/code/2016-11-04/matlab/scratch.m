...
fileStr.root   = fullfile(modelRoot,'data/2016-11-04/preproc01/subj%.2d/dt%d/%s/%s/');
...
choiceMech              = 'race';
stopMech                = 'none';
fileStr.root            = strcat(modelRoot,'/data/2016-11-04/preproc01/subj%.2d/dt5/%s/%s/');
doPlot                  = true;
doSave                  = true;
doStartParCluster       = false;

cd(fullfile(modelRoot,'src/code/2016-11-04/matlab'));
