...
for iSubj = subj
    ...
    load(io.behavFile)
    expt.nSsd                     = numel(unique(data.ssd(data.ssd > 0)));
    ...
    % zc_{Go}, z0_{Go}, t0_{G0}, v_{Go}, ve_{Go}: allowed to vary between responses;
    % zc_{Go}, v_{Go}, ve_{Go}, wli_{Go}, and wffi_{Go}: allowed to vary between conditions
    features(2,XCat.i.iZ0,1)      = true; %pgm
    features(2,XCat.i.iZc,1)      = true;
    features(3,XCat.i.iZc,1)      = true;
    features(2,XCat.i.iV,1)       = true;
    features(2,XCat.i.iVe,1)      = true;
    features(3,XCat.i.iV,1)       = true;
    features(3,XCat.i.iVe,1)      = true;
    features(2,XCat.i.iT0,1)      = true;
