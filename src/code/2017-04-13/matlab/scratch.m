...
fileStr.root   = fullfile(modelRoot,'data/2017-04-13/preproc01/subj%.2d/dt%d/%s/%s/');
...
choiceMech              = 'race';
stopMech                = 'none';
fileStr.root            = strcat(modelRoot,'/data/2017-04-13/preproc01/subj%.2d/dt5/%s/%s/');
doPlot                  = true;
doSave                  = true;
doStartParCluster       = false;

cd(fullfile(modelRoot,'src/code/2017-04-13/matlab'));
