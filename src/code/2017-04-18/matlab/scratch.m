...
fileStr.root   = fullfile(modelRoot,'data/2017-04-18/preproc01/subj%.2d/dt%d/%s/%s/');
...
choiceMech              = 'race';
stopMech                = 'none';
fileStr.root            = strcat(modelRoot,'/data/2017-04-18/preproc01/subj%.2d/dt5/%s/%s/');
doPlot                  = true;
doSave                  = true;
doStartParCluster       = false;

cd(fullfile(modelRoot,'src/code/2017-04-18/matlab'));
...
%%  Check Xena's stop Rts
 load('~/perceptualchoice_stop_model/data/2017-04-18/preproc01/subj02/data_subj02.mat')
...
for cnd = 1:3
       ...
       %%  Check Xena's stop Rts
 load('~/perceptualchoice_stop_model/data/2017-04-18/preproc01/subj01/data_subj01.mat')
